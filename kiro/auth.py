...
_STARTUP_FAILURE_GUIDANCE = (
    ...
    "║  Gateway 无法使用任何已配置的账号启动，请检查:              ║\n"
    "╠══════════════════════════════════════════════════════════════╣\n"
    "║  📁 Kiro IDE: 打开 Kiro IDE 重新登录                       ║\n"
    "║     确认文件已更新: ~/.aws/sso/cache/kiro-auth-token.json  ║\n"
    "║  🖥️  kiro-cli: 运行 kiro-cli login 并完成浏览器登录         ║\n"
    "║  🔑 .env: 检查 REFRESH_TOKEN 是否有效，必要时重新获取      ║\n"
    "║  🌐 网络: 确认可访问 AWS，如需代理设置 VPN_PROXY_URL       ║\n"
    "╠══════════════════════════════════════════════════════════════╣\n"
    "║  完成后重启: python main.py                                ║\n"
    "║  💬 仍有问题? https://github.com/jwadow/kiro-gateway/issues║\n"
    "╚══════════════════════════════════════════════════════════════╝"
)
